...
import io.demo.potter.softwareexample.core.domain.Comparison;
...
public class Condition {
    ...
    public static class ConditionBuilder implements ConditionWithField, ConditionComparing, ConditionComplete {
        ...
        /**
         * (non-Javadoc)
         * @see io.demo.potter.softwareexample.core.repository.Condition.ConditionWithField#is(io.demo.potter.softwareexample.core.domain.Comparison)
         */
        @Override
        ...
        /**
         * (non-Javadoc)
         * @see io.demo.potter.softwareexample.core.repository.Condition.ConditionComparing#value(java.lang.Object)
         */
        @Override
        ...
        /**
         * (non-Javadoc)
         * @see io.demo.potter.softwareexample.core.repository.Condition.ConditionComplete#build()
         */
        @Override
