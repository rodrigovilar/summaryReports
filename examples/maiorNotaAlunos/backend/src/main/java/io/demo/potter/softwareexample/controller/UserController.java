...
import io.demo.potter.softwareexample.dto.UserDTO;
import io.demo.potter.softwareexample.model.User;
import io.demo.potter.softwareexample.service.UserService;
...
public class UserController extends CrudBaseController<User, Integer, UserDTO> {
	...
	/**
	 * (non-Javadoc)
	 * @see io.demo.potter.softwareexample.core.controller.SearchBaseController#toModel(io.demo.potter.softwareexample.core.dto.ModelDTO)
	 */
	@Override
